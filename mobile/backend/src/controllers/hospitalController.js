...
const getHospitals = async (req, res) => {
  try {
    ...
    // Fallback coordinates (Islamabad) if query parameters are missing
    const userLat = parseFloat(lat || 33.6844);
    const userLng = parseFloat(lng || 73.0479);

    // NOTE: table name standardized to dbo.hospitals to match
    // emergencyController.js and avoid relying on case-insensitive collation.

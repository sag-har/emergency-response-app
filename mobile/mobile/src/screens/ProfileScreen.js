  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity style={styles.editButton} onPress={() => Alert.alert("Coming Soon", "Edit Profile will be available in the next update.")}>
...
const styles = StyleSheet.create({
  ...
  editButton: { marginHorizontal: 20, backgroundColor: "#2563EB", height: 52, borderRadius: 14, justifyContent: "center", alignItems: "center", flexDirection: "row", marginTop: 20 },
  editButtonText: { color: "#FFFFFF", fontWeight: "700", marginLeft: 10, fontSize: 16 },
  logoutButton: { marginHorizontal: 20, backgroundColor: "#D62828", height: 52, borderRadius: 14, justifyContent: "center", alignItems: "center", flexDirection: "row", marginTop: 12 },
